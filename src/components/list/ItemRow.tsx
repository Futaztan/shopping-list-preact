...
/**
 * Egy elem sora a listába
 *
 * @param item - Kiírandó elem
 * @param onTogglePurchased - Megvásárolt ki/be kapcsolása
 * @param onStartEditing - Elem módosításnak elkezdése
 * @param onDelete - Törlés függvény
 * @returns Az elem sora
 */
